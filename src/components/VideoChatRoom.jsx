...
const VideoChatRoom = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col grow lg:flex-row justify-around items-center p-2 lg:py-4 bg-fourth">
        <div className=" max-w-lg w-full p-2 flex flex-col justify-center">
